...
get_min_price = float(input("Enter Minum price: "))
get_max_price = float(input("Enter Maximum price: "))

def get_products_in_price_range(products: list[dict], min_price: float, max_price: float) -> list[dict]:
    result = []
    
    for product in products:
        if get_min_price <= product["price"] <= get_max_price:
...
pprint(get_products_in_price_range(products, get_min_price, get_max_price))
